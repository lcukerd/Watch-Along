...
class MemberName extends Component {
    ...
    enterRoom = name => store.dispatch({ type: actions.UPDATE_NAME, payload: { name } });
        ...
        return (
            <Card style={{ position: 'absolute', top: '50%', left: '50%', width: '18rem', transform: 'translate(-50%, -50%)', margin: '10px', backgroundColor: '#f06292' }}>
                <Card.Body>
                    ...
                    <Button onClick={() => this.enterRoom(this.name.value)} style={{ backgroundColor: '#ba2d65', 'borderColor': '#ba2d65', marginTop: '17px' }}>Let's go</Button>
                </Card.Body>
            </Card>
        );
    }
