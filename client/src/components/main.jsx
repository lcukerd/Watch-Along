                        ...
                        <Col>
                            <Card style={{ width: '18rem', margin: '4px', backgroundColor: '#f06292' }}>
                                <Card.Body>
                                    ...
                                    <Button onClick={() => this.enterRoom(parseInt((new Date()).getTime() / 1000))} style={{ backgroundColor: '#ba2d65', 'borderColor': '#ba2d65' }}>Let's go</Button >
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col>
                            <Card style={{ width: '18rem', margin: '4px', backgroundColor: '#f06292' }}>
                                <Card.Body>
                                    ...
                                    <Button onClick={() => this.enterRoom(this.roomId.value)} style={{ backgroundColor: '#ba2d65', 'borderColor': '#ba2d65', marginTop: '17px' }}>Let's go</Button>
                                </Card.Body>
                            </Card>
                        </Col>
                    </Row>
